...
const LABELS = {
  ru: {
    ...
    toMyRecords: "Открыть мои записи →",
    myRecordsTitle: "Мои записи",
    myRecordsSub: "Чеклисты, активные заявки и история визитов",
    myTabUpcoming: "Активные",
    myTabCompleted: "Завершённые",
    myTabAll: "Все",
    myEmptyUpcoming: "Нет активных записей. Запишитесь на приём — чек появится здесь.",
    myEmptyCompleted: "Завершённых визитов пока нет.",
    myEmptyAll: "История пуста. После первой записи все чеклисты сохранятся здесь.",
    myRejectedHint: "Отклонённые заявки отображаются только во вкладке «Все».",
    profileAutofillHint: "Данные подставлены автоматически — при необходимости измените их.",
    ...
    successSub: "Чек сохранён в разделе «Мои записи»",
    successNote: "Откройте «Мои записи» в меню, чтобы видеть статус и историю",
  ...
  tj: {
    ...
    myRecords: "Қабулҳои ман",
    toMyRecords: "Қабулҳои ман →",
    myRecordsTitle: "Қабулҳои ман",
    myRecordsSub: "Чекҳо, дархостҳои фаъол ва таърихи ташrifот",
    myTabUpcoming: "Фаъол",
    myTabCompleted: "Анҷомёфта",
    myTabAll: "Ҳама",
    myEmptyUpcoming: "Қабили фаъол нест. Қабул гиред — чек инҷо пайдо мешавад.",
    myEmptyCompleted: "Ташrifоти анҷомёфта ҳоло нест.",
    myEmptyAll: "Таърих холӣ аст. Пас аз аввалин қабул ҳама чекҳо инҷо нигоҳ дошта мешаванд.",
    myRejectedHint: "Дархостҳои радшуда танҳо дар «Ҳама» намоён мешаванд.",
    profileAutofillHint: "Маълумот худкор пур шуд — дар сурати зарурат тағир диҳед.",
    contactsTitle: "Тамос",
    ...
    successSub: "Чек дар «Қабулҳои ман» сабт шуд",
    successNote: "Барои дидани ҳолат ва таърих «Қабулҳои ман»-ро дар меню кушоед",

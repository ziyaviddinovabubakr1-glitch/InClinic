        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">
          {doctors.map((doctor) => (
            <div key={doctor.id} className="glass-card overflow-hidden flex flex-col w-full">
              <div
                className="doctor-card-banner flex-shrink-0 relative"
                style={{ background:"linear-gradient(135deg,rgba(14,165,233,0.22),rgba(6,182,212,0.12))" }}
              >
                <div className="doctor-card-banner-inner absolute inset-x-0 flex justify-center">
                  <DoctorAvatar
              ...
              <div className="doctor-card-body pb-6 px-5 flex flex-col items-center text-center flex-1">
